...
export class Backend implements backendInterface {
    ...
    async addKayakDesign(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addKayakDesign(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllKayakDesigns(): Promise<Array<KayakDesign>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllKayakDesigns();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
